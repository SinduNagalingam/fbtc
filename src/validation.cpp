...
#if defined(NDEBUG)
# error "FBTC cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "FBTC Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s FBTC additional fees, %d delta bytes\n",
